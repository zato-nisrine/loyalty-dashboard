...
export default async function AdminDashboardPage() {
  ...
  const activeRestaurants = restaurants.filter((r: any) => r.subscriptionStatus === 'active').length
  const trialRestaurants = restaurants.filter((r: any) => r.subscriptionStatus === 'trial').length
  const expiredRestaurants = restaurants.filter((r: any) => r.subscriptionStatus === 'expired').length
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="rounded-2xl border border-stone-200 bg-white p-5">
          ...
          <p className="text-xs font-medium uppercase tracking-wide text-stone-500">Total restaurants</p>
          <p className="mt-1 font-[family-name:var(--font-display)] text-3xl font-semibold text-stone-900">{totalRestaurants}</p>
        </div>
        <div className="rounded-2xl border border-stone-200 bg-white p-5">
          ...
          <p className="mt-1 font-[family-name:var(--font-display)] text-3xl font-semibold text-stone-900">{activeRestaurants}</p>
        </div>
        <div className="rounded-2xl border border-stone-200 bg-white p-5">
          ...
          <p className="mt-1 font-[family-name:var(--font-display)] text-3xl font-semibold text-stone-900">{trialRestaurants}</p>
        </div>
        <div className="rounded-2xl border border-stone-200 bg-white p-5">
          ...
          <p className="mt-1 font-[family-name:var(--font-display)] text-3xl font-semibold text-stone-900">{expiredRestaurants}</p>
        </div>
      </div>
